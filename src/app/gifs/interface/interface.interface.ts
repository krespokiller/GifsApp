// To parse this data:
//
//   import { Convert, Responsegiphy } from "./file";
//
//   const responsegiphy = Convert.toResponsegiphy(json);
//
...
export class Convert {
    public static toResponsegiphy(json: string): Responsegiphy {
        return cast(JSON.parse(json), r("Responsegiphy"));
    }

    public static responsegiphyToJson(value: Responsegiphy): string {
        return JSON.stringify(uncast(value, r("Responsegiphy")), null, 2);
    }
}
